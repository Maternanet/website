...
<div class="copyrights bg-primary py-4">
  <div class="container">
    <div class="row">
        ...
        >
          <li class="list-group-item border-0 bg-transparent p-0">
            <a
              ...
              target="_blank"
              class="text-white px-2"><i class="fab fa-facebook-f" /></a
            >
          </li>
          <li class="list-group-item border-0 bg-transparent p-0">
            <a
              ...
              target="_blank"
              class="text-white px-2"><i class="fab fa-twitter" /></a
            >
          </li>
          <li class="list-group-item border-0 bg-transparent p-0">
            <a
              href="https://www.linkedin.com"
              class="text-white px-2"><i class="fab fa-linkedin-in" /></a
            >
          </li>
          <li class="list-group-item border-0 bg-transparent p-0">
            <a
              href="https://www.youtube.com"
              class="text-white px-2"><i class="fab fa-youtube" /></a
            >
          </li>
        </ul>
      </div>
