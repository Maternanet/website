            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse main-menu">
                    ...
                    <div class="header-btn d-inline-flex">
                        <a href="/contacts" class="btn-default btn-highlighted"
                            >Partner With Us</a
                        >
                    </div>
                ...
                <div class="navbar-toggle">
                    <button
                        ...
                        style="outline: none; background: transparent; border: 0; padding: 0;"
                    >
                        <span class="slicknav_menutxt"></span>
                        <span class="slicknav_icon slicknav_no-text"
                            ><span class="slicknav_icon-bar"></span><span
                                class="slicknav_icon-bar"
        ...
        <div class="responsive-menu">
            <div class="slicknav_menu">
                ...
                >
                    ...
                    <li class="nav-item highlighted-menu">
                        <a class="nav-link" href="/contacts">Partner With Us</a>
                    </li>
                </ul>
            </div>
        </div>
