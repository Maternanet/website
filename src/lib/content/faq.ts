    ...
    items: [
      {
        ...
        a: '<p>Maternanet identifies pregnant women who are at high risk of complications <strong>weeks before those complications occur</strong>. We do this by giving community health workers digital tools to screen mothers at home, running that data through an AI risk model, and sending an automatic alert when a mother\'s risk profile crosses a threshold. The CHP then makes a priority visit or coordinates a clinic appointment before an emergency develops.</p><p>Think of it as a smoke detector for maternal health — except instead of detecting a fire already burning, it detects the conditions that make a fire likely. We also help remove the financial barrier to acting on that alert through our Care Now, Lipa Later microfinancing partnership.</p><div class="highlight-box">We are not a telemedicine app. We are not a symptom checker. We are the predictive intelligence layer that operates upstream of every other intervention.</div>'
      },
      {
        id: 'platform-2',
        num: '2',
        q: 'How does the AI risk model work? What variables does it use?',
      ...
      },
      {
        ...
        a: '<p>This is by design, not an afterthought. <strong>60% of our users access via SMS or USSD</strong> on feature phones with no data connection.</p><ul><li><strong>Edge computing:</strong> Compressed AI algorithms run locally on rugged tablets and clinic PCs — risk scoring without cloud access</li><li><strong>Data caching:</strong> Screenings logged locally with timestamps, syncing bidirectionally when any connection — even 2G — becomes available</li><li><strong>SMS/USSD interface:</strong> Mothers receive risk alerts, reminders, and health nudges via basic text — no smartphone or data plan required</li><li><strong>85% accuracy maintained offline</strong> — validated in field conditions below 1kb/second connectivity</li></ul><p>Patent filed: "Distributed Healthcare AI with Progressive Sync" — Kenya Patent Office, Application #2024/789.</p>'
      },
      {
        id: 'platform-4',
        num: '4',
        q: 'Does Maternanet replace doctors and nurses?',
        a: '<p>No. Maternanet operates on a strict <strong>human-in-the-loop principle</strong>. Our AI flags and recommends — it never decides or acts autonomously. Every alert generates a human action: a CHP visit, a clinical escalation, a facility appointment. The clinician always makes the final call.</p><p>In a context where Africa faces a shortage of 6.1 million healthcare workers, our goal is to make every CHP significantly more effective — helping them prioritise their caseloads intelligently and focus their limited time on the mothers who need them most.</p><div class="highlight-box">Our model explains why it flagged a mother — not just that it did. Trust in AI is earned through transparency, not assumed through authority.</div>'
      },
      {
        id: 'platform-5',
        num: '5',
        q: 'How does Maternanet integrate with existing health systems — DHIS2, EMRs?',
        a: '<p>Maternanet integrates natively with Kenya\'s national <strong>DHIS2</strong> system and most facility-level EMRs in active counties:</p><ul><li>County health departments access population-level risk dashboards without additional data entry</li><li>Outcome data validates automatically against government records</li><li>Facilities do not change existing workflows — our platform reads from and writes to systems they already use</li></ul><p><strong>Setup:</strong> 2–4 weeks including staff training. One-time $300 fee + $65/month facility licence. Contact info@maternanet.com to begin.</p>'
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        a: '<p>Across 4 active Kenyan counties (Nairobi, Narok, Kajiado) over 12 months of deployment:</p><div class="stat-row"><div class="stat-chip"><span>+21pp</span>ANC completion</div><div class="stat-chip"><span>−15%</span>Missed appointments</div><div class="stat-chip"><span>77%</span>6-month retention</div><div class="stat-chip"><span>12+</span>Lives saved/yr</div><div class="stat-chip"><span>$8,100</span>Cost per life saved</div></div><p><strong>Validation:</strong> ANC data cross-referenced against county DHIS2 records and independent clinic registers. Our quasi-experimental evaluation uses difference-in-differences methodology with matched comparison sites. A stepped-wedge cluster RCT is in preparation with a Kenyan university partner for Year 3–5 validation.</p>'
      },
      {
        id: 'impact-2',
        num: '7',
        q: 'How cost-effective is Maternanet compared to standard maternal health interventions?',
        a: '<p>Currently <strong>$8,100 per life saved</strong>, projected to fall to <strong>$650–$1,300 by 2028</strong> as scale increases. The WHO estimates skilled birth attendance programmes cost $4,000–$12,000 per maternal death prevented — our model is competitive now and improves dramatically with volume.</p><p>Early intervention also reduces average care costs by up to <strong>70%</strong> by treating complications early rather than managing emergencies.</p><div class="highlight-box">Every $1 invested in Maternanet generates $7–$20 in long-term economic benefits — reduced emergency care costs, maternal productivity gains, and household poverty prevention.</div>'
      },
      {
        id: 'impact-3',
        num: '8',
        q: 'Can pre-eclampsia and other complications actually be predicted weeks in advance?',
        a: '<p>Yes — and this is the clinical foundation of Maternanet. Machine learning risk models for pre-eclampsia and obstetric complications have been validated in peer-reviewed literature (BioMed Central, WHO Digital Guidelines) showing clinically useful discrimination using routine maternal data. Digital twin simulation for prenatal risk monitoring is an emerging but evidence-supported methodology.</p><p>Our model identifies the <strong>combination of signals</strong> that, in aggregate, indicate elevated risk weeks before clinical symptoms manifest — giving CHPs and clinicians a window for intervention that standard screening misses entirely.</p>'
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        a: '<p>A Digital Doula is a community health provider (CHP) trained and equipped by Maternanet to conduct door-to-door screenings, follow up on AI-flagged high-risk mothers, and bridge the household-to-clinic gap where most maternal deaths happen.</p><ul><li><strong>10-day intensive bootcamp:</strong> clinical basics, AI-app usage, device handling, escalation protocols</li><li><strong>Continuous digital refreshers</strong> accessible offline on tablet or SMS</li><li><strong>Quarterly in-person workshops</strong> for peer learning and protocol updates</li><li><strong>Maximum 200 mothers per CHP</strong> with performance-based incentives</li></ul><p>Currently <strong>410 active Digital Doulas</strong> across 4 counties, with a <strong>96% retention rate</strong>.</p>'
      },
      {
        id: 'community-2',
        num: '10',
        q: 'How do you ensure cultural sensitivity and community trust — especially with AI?',
        a: '<p>Most digital health interventions fail here. We built Maternanet from within the communities we serve — our founding team comes from these regions and understands that trust is earned through presence, not technology.</p><ul><li><strong>Co-design:</strong> Features shaped in local workshops before they are built, not after</li><li><strong>Digital Doula ambassadors</strong> moderate peer forums — the platform is an extension of trusted social networks</li><li><strong>Local language delivery:</strong> SMS nudges in Swahili and local dialects</li><li><strong>Federated learning:</strong> AI models trained on-site without raw personal data leaving the community</li><li><strong>Explainable AI:</strong> Providers and mothers see why the model flagged a risk, not just that it did</li></ul><p>Our 77% weekly engagement and retention rate — in communities with historically low digital health adoption — is the evidence this approach works.</p>'
      },
      {
        id: 'community-3',
        num: '11',
        q: 'What happens when a mother can\'t afford care after being flagged as high-risk?',
        a: '<p>Detecting risk without removing the barrier to acting on it is not a solution. Maternanet addresses the financial barrier through two mechanisms:</p><ul><li><strong>Care Now, Lipa Later:</strong> Microfinance institution partnerships providing credit for predictively identified high-risk interventions — accessible at the point of the alert, not after a missed appointment</li><li><strong>Micro-saving wallets:</strong> Mothers save incrementally via mobile wallet — as little as KSh 30 per deposit — earmarked for delivery costs, reducing reliance on emergency borrowing</li></ul><p>Our B2B revenue model subsidises care at the household level. The mother pays nothing extra. We take from the institutional top of the pyramid and give to the bottom.</p>'
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        a: '<ul><li><strong>Phase 1 (2025–2028) — Kenya data foundation:</strong> 8+ counties, 80+ facilities, 500+ CHPs. Build national policy evidence base.</li><li><strong>Phase 2 (2028–2030) — National scale:</strong> Hub &amp; Spoke expansion across Kenya, full DHIS2 and EHR integration, county cost-sharing.</li><li><strong>Phase 3 (2031–2035) — Pan-African entry:</strong> Uganda, Tanzania, Rwanda, Nigeria, Ghana.</li></ul><p>Long-term vision: 500,000+ women across 5 countries, Kenya achieving fewer than 150 maternal deaths per 100,000 live births by 2030.</p>'
      },
      {
        id: 'scale-2',
        num: '19',
        q: 'Can Maternanet\'s model work in my country? What does deployment require?',
        a: '<p>Our model is transferable wherever three conditions exist: a community health worker structure, 2G mobile coverage (minimum), and a maternal mortality challenge driven by detection delays and access barriers. That describes most of sub-Saharan Africa.</p><p>Deployment requirements:</p><ul><li>A local implementation partner with existing community health networks</li><li>A Ministry or county health department willing to sandbox with us</li><li>6–12 months for AI model localisation, consent framework adaptation, and regulatory clearance</li><li>Minimum cohort of 50 CHPs and 2 facility partners to build data density for model accuracy</li></ul><p>We are actively seeking early-mover partners in Uganda, Tanzania, Rwanda, Nigeria, and Ghana. Contact info@maternanet.com with your context.</p>'
      },
      {
        id: 'scale-3',
        num: '20',
