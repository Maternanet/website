              ...
              <div class="card-footer">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0 avatar-group avatar-group-xs">
                    ...
                    <a class="avatar avatar-xs avatar-circle" href="#" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="John O'nolan" data-bs-original-title="John O'nolan">
            ...
            <div class="card-footer">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0 avatar-group avatar-group-xs">
                  ...
                  <a class="avatar avatar-xs avatar-circle" href="#" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Emily Milda" data-bs-original-title="Emily Milda">
        ...
        <div class="col-sm-6 col-lg-4 mb-4">
          ...
          <div class="card h-100">
            ...
            <div class="card-footer">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0 avatar-group avatar-group-xs">
                  <a class="avatar avatar-xs avatar-circle" href="#" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Hanna Wolfe" data-bs-original-title="Hanna Wolfe">
